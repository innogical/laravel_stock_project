        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form class="needs-validation" novalidate action="/backoffice/<?php echo e($id); ?>" method="post"
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="product_name"
                                       placeholder="<?php echo e($content->product_name); ?>"
                                       required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="product_weight"
                                       placeholder="<?php echo e($content->product_total); ?>"
                                       required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="product_price"
                                       placeholder="<?php echo e($content->product_price); ?>"
                                       required>
                                <div class="invalid-feedback">
                                    กรุณาใส่จำนวนกิโลกริม
                                </div>
